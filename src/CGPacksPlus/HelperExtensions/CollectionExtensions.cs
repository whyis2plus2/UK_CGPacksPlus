...
public static class CollectionExtensions
{
    ...
    {
        /// <summary>
        /// Perform an action on every item of an <see cref="ICollection{T}" />
        /// </summary>
        ...
        public void Add(params T[] items) => items.ForEach(self.Add);
        ...
        /// <exception cref="NotSupportedException" />
        public void Add(params ICollection<T>[] collections) => collections.ForEach(c => self.Add(c.ToArray()));
        ...
        /// <exception cref="NotSupportedException" />
        public void AddDistinct(params T[] items) => self.Add(items.Except(self).ToArray());
        ...
        /// <param name="collections">The collections that will have their contents appended</param>
        /// <exception cref="NotSupportedException" />
        public void AddDistinct(params ICollection<T>[] collections) =>
